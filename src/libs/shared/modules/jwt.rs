...
impl JwtManager {
    ...
    pub fn generate_token_pair(&self, user_id: &str, email: &str) -> Result<TokenPair, jsonwebtoken::errors::Error> {
        let now = Utc::now();
    ...
    pub fn refresh_access_token(&self, refresh_token: &str) -> Result<String, jsonwebtoken::errors::Error> {
